SE DUYÊN 4.0
1. Giới thiệu
   SE DUYÊN 4.0 là chương trình C mô phỏng hệ thống quản lý dữ liệu sử dụng danh sách liên kết đơn. Dự án nhằm rèn luyện kỹ năng lập trình cấu trúc, quản lý bộ nhớ động, chia module và thao tác file.
